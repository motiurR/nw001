                ...
                <div class="row">
                    <div class="col-lg-9">
                        <div class="row">
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $jhalokathitNews = $news->jhalokathiTopNews();
                                  if ($jhalokathitNews) {
                                    while ($result = $jhalokathitNews->fetch_assoc()) {
                              ?>
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $jhalokathialNews = $news->jhalokathiallNews();
                                  if ($jhalokathialNews) {
                                    while ($result = $jhalokathialNews->fetch_assoc()) {
                              ?>
                             <div class="col-lg-6">
                                <div class="content">
                                    <div class="col-lg-6">
