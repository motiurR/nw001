                ...
                <div class="row">
                    <div class="col-lg-9">
                        <div class="row">
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $jaipurhatTNews = $news->getTopjaipurhatNews();
                                  if ($jaipurhatTNews) {
                                    while ($result = $jaipurhatTNews->fetch_assoc()) {
                              ?>
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $jaipurhatNews = $news->getAlljaipurhatNews();
                                  if ($jaipurhatNews) {
                                    while ($result = $jaipurhatNews->fetch_assoc()) {
                              ?>
                             <div class="col-lg-6">
                                <div class="content">
                                    <div class="col-lg-6">
