                ...
                <div class="row">
                    <div class="col-lg-9">
                        <div class="row">
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $sunamganjTNews = $news->getTopsunamganjNews();
                                  if ($sunamganjTNews) {
                                    while ($result = $sunamganjTNews->fetch_assoc()) {
                              ?>
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $sunamganjNews = $news->getAllsunamganjNews();
                                  if ($sunamganjNews) {
                                    while ($result = $sunamganjNews->fetch_assoc()) {
                              ?>
                             <div class="col-lg-6">
                                <div class="content">
                                    <div class="col-lg-6">
