                ...
                <div class="row">
                    <div class="col-lg-9">
                        <div class="row">
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $chittagongTNews = $news->getTopChittagongNews();
                                  if ($chittagongTNews) {
                                    while ($result = $chittagongTNews->fetch_assoc()) {
                              ?>
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $chittagongNews = $news->getAllChittagongNews();
                                  if ($chittagongNews) {
                                    while ($result = $chittagongNews->fetch_assoc()) {
                              ?>
                             <div class="col-lg-6">
                                <div class="content">
                                    <div class="col-lg-6">
