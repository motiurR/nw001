                ...
                <div class="row">
                    <div class="col-lg-9">
                        <div class="row">
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $khagracharitNews = $news->khagrachariTopNews();
                                  if ($khagracharitNews) {
                                    while ($result = $khagracharitNews->fetch_assoc()) {
                              ?>
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $khagracharialNews = $news->khagrachariallNews();
                                  if ($khagracharialNews) {
                                    while ($result = $khagracharialNews->fetch_assoc()) {
                              ?>
                             <div class="col-lg-6">
                                <div class="content">
                                    <div class="col-lg-6">
