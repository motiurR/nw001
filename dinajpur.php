                ...
                <div class="row">
                    <div class="col-lg-9">
                        <div class="row">
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $dinajpurtTNews = $news->dinajpurTopNews();
                                  if ($dinajpurtTNews) {
                                    while ($result = $dinajpurtTNews->fetch_assoc()) {
                              ?>
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $ldinajpuralNews = $news->dinajpurallNews();
                                  if ($ldinajpuralNews) {
                                    while ($result = $ldinajpuralNews->fetch_assoc()) {
                              ?>
                             <div class="col-lg-6">
                                <div class="content">
                                    <div class="col-lg-6">
