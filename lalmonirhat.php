                ...
                <div class="row">
                    <div class="col-lg-9">
                        <div class="row">
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $lalmonirhatTNews = $news->lalmonirhatTopNews();
                                  if ($lalmonirhatTNews) {
                                    while ($result = $lalmonirhatTNews->fetch_assoc()) {
                              ?>
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $lalmonirhatalNews = $news->lalmonirhatallNews();
                                  if ($lalmonirhatalNews) {
                                    while ($result = $lalmonirhatalNews->fetch_assoc()) {
                              ?>
                             <div class="col-lg-6">
                                <div class="content">
                                    <div class="col-lg-6">
