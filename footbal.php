                ...
                <div class="row">
                    <div class="col-lg-9">
                        <div class="row">
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $footbalTNews = $news->getFootbalTopNews();
                                  if ($footbalTNews) {
                                    while ($result = $footbalTNews->fetch_assoc()) {
                              ?>
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $footbalAllTNews = $news->getAllfootballNewsinner();
                                  if ($footbalAllTNews) {
                                    while ($result = $footbalAllTNews->fetch_assoc()) {
                              ?>
                             <div class="col-lg-6">
                                <div class="content">
                                    <div class="col-lg-6">
