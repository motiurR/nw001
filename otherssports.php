                ...
                <div class="row">
                    <div class="col-lg-9">
                        <div class="row">
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $othersportsTNews = $news->getothersportsTopNews();
                                  if ($othersportsTNews) {
                                    while ($result = $othersportsTNews->fetch_assoc()) {
                              ?>
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $othersportsAllTNews = $news->getAllOthersportsNews();
                                  if ($othersportsAllTNews) {
                                    while ($result = $othersportsAllTNews->fetch_assoc()) {
                              ?>
                             <div class="col-lg-6">
                                <div class="content">
                                    <div class="col-lg-6">
