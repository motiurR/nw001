                ...
                <div class="row">
                    <div class="col-lg-9">
                        <div class="row">
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $munsigonjtNews = $news->munsigonjTopNews();
                                  if ($munsigonjtNews) {
                                    while ($result = $munsigonjtNews->fetch_assoc()) {
                              ?>
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $munsigonjalNews = $news->munsigonjallNews();
                                  if ($munsigonjalNews) {
                                    while ($result = $munsigonjalNews->fetch_assoc()) {
                              ?>
                             <div class="col-lg-6">
                                <div class="content">
                                    <div class="col-lg-6">
