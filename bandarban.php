                ...
                <div class="row">
                    <div class="col-lg-9">
                        <div class="row">
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $bandarbantNews = $news->bandarbanTopNews();
                                  if ($bandarbantNews) {
                                    while ($result = $bandarbantNews->fetch_assoc()) {
                              ?>
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $bandarbanalNews = $news->bandarbanallNews();
                                  if ($bandarbanalNews) {
                                    while ($result = $bandarbanalNews->fetch_assoc()) {
                              ?>
                             <div class="col-lg-6">
                                <div class="content">
                                    <div class="col-lg-6">
