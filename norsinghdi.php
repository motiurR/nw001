                ...
                <div class="row">
                    <div class="col-lg-9">
                        <div class="row">
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $norsinghdiTNews = $news->getTopnorsinghdiNews();
                                  if ($norsinghdiTNews) {
                                    while ($result = $norsinghdiTNews->fetch_assoc()) {
                              ?>
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $norsinghdiNews = $news->getAllnorsinghdiNews();
                                  if ($norsinghdiNews) {
                                    while ($result = $norsinghdiNews->fetch_assoc()) {
                              ?>
                             <div class="col-lg-6">
                                <div class="content">
                                    <div class="col-lg-6">
