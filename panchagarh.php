                ...
                <div class="row">
                    <div class="col-lg-9">
                        <div class="row">
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $panchagarhTNews = $news->getToppanchagarhNews();
                                  if ($panchagarhTNews) {
                                    while ($result = $panchagarhTNews->fetch_assoc()) {
                              ?>
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $panchagarhNews = $news->getAllpanchagarhNews();
                                  if ($panchagarhNews) {
                                    while ($result = $panchagarhNews->fetch_assoc()) {
                              ?>
                             <div class="col-lg-6">
                                <div class="content">
                                    <div class="col-lg-6">
