                ...
                <div class="row">
                    <div class="col-lg-9">
                        <div class="row">
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $madaripurTNews = $news->madaripurTopNews();
                                  if ($madaripurTNews) {
                                    while ($result = $madaripurTNews->fetch_assoc()) {
                              ?>
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $madaripuralNews = $news->madaripurallNews();
                                  if ($madaripuralNews) {
                                    while ($result = $madaripuralNews->fetch_assoc()) {
                              ?>
                             <div class="col-lg-6">
                                <div class="content">
                                    <div class="col-lg-6">
