                ...
                <div class="row">
                    <div class="col-lg-9">
                        <div class="row">
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $chapainawabganjTNews = $news->getTopchapainawabganjNews();
                                  if ($chapainawabganjTNews) {
                                    while ($result = $chapainawabganjTNews->fetch_assoc()) {
                              ?>
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $chapainawabganjNews = $news->getAllchapainawabganjNews();
                                  if ($chapainawabganjNews) {
                                    while ($result = $chapainawabganjNews->fetch_assoc()) {
                              ?>
                             <div class="col-lg-6">
                                <div class="content">
                                    <div class="col-lg-6">
