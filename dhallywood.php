                ...
                <div class="row">
                    <div class="col-lg-9">
                        <div class="row">
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $dhaliwoodTNews = $news->getDhallywoodTopNews();
                                  if ($dhaliwoodTNews) {
                                    while ($result = $dhaliwoodTNews->fetch_assoc()) {
                              ?>
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $dhallywoodAllTNews = $news->getAlldhallywoodNewsinner();
                                  if ($dhallywoodAllTNews) {
                                    while ($result = $dhallywoodAllTNews->fetch_assoc()) {
                              ?>
                             <div class="col-lg-6">
                                <div class="content">
                                    <div class="col-lg-6">
