                ...
                <div class="row">
                    <div class="col-lg-9">
                        <div class="row">
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $kishoregonjTNews = $news->getTopkishoregonjNews();
                                  if ($kishoregonjTNews) {
                                    while ($result = $kishoregonjTNews->fetch_assoc()) {
                              ?>
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $kishoregonjNews = $news->getAllkishoregonjNews();
                                  if ($kishoregonjNews) {
                                    while ($result = $kishoregonjNews->fetch_assoc()) {
                              ?>
                             <div class="col-lg-6">
                                <div class="content">
                                    <div class="col-lg-6">
