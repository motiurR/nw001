                ...
                <div class="row">
                    <div class="col-lg-9">
                        <div class="row">
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $bollywoodTNews = $news->gethollyllywoodTopNews();
                                  if ($bollywoodTNews) {
                                    while ($result = $bollywoodTNews->fetch_assoc()) {
                              ?>
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $bollywoodAllTNews = $news->getAllhollywoodNewsinner();
                                  if ($bollywoodAllTNews) {
                                    while ($result = $bollywoodAllTNews->fetch_assoc()) {
                              ?>
                             <div class="col-lg-6">
                                <div class="content">
                                    <div class="col-lg-6">
