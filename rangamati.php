                ...
                <div class="row">
                    <div class="col-lg-9">
                        <div class="row">
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $rangamatitNews = $news->rangamatiTopNews();
                                  if ($rangamatitNews) {
                                    while ($result = $rangamatitNews->fetch_assoc()) {
                              ?>
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $rangamatialNews = $news->rangamatiallNews();
                                  if ($rangamatialNews) {
                                    while ($result = $rangamatialNews->fetch_assoc()) {
                              ?>
                             <div class="col-lg-6">
                                <div class="content">
                                    <div class="col-lg-6">
