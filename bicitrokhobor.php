                ...
                <div class="row">
                    <div class="col-lg-9">
                        <div class="row">
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $bicitrotTNews = $news->getTopbicitroNews();
                                  if ($bicitrotTNews) {
                                    while ($result = $bicitrotTNews->fetch_assoc()) {
                              ?>
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $bicitroTNews = $news->getAllbicitroNewsinner();
                                  if ($bicitroTNews) {
                                    while ($result = $bicitroTNews->fetch_assoc()) {
                              ?>
                             <div class="col-lg-6">
                                <div class="content">
                                    <div class="col-lg-6">
