                ...
                <div class="row">
                    <div class="col-lg-9">
                        <div class="row">
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $lifestyleTNews = $news->getjibonjaponTopNews();
                                  if ($lifestyleTNews) {
                                    while ($result = $lifestyleTNews->fetch_assoc()) {
                              ?>
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $lifestyleAllTNews = $news->getAlljibonjaponNewsinner();
                                  if ($lifestyleAllTNews) {
                                    while ($result = $lifestyleAllTNews->fetch_assoc()) {
                              ?>
                             <div class="col-lg-6">
                                <div class="content">
                                    <div class="col-lg-6">
