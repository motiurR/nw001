                ...
                <div class="row">
                    <div class="col-lg-9">
                        <div class="row">
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $nilphamariTNews = $news->nilphamariTopNews();
                                  if ($nilphamariTNews) {
                                    while ($result = $nilphamariTNews->fetch_assoc()) {
                              ?>
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $nilphamarialNews = $news->nilphamariallNews();
                                  if ($nilphamarialNews) {
                                    while ($result = $nilphamarialNews->fetch_assoc()) {
                              ?>
                             <div class="col-lg-6">
                                <div class="content">
                                    <div class="col-lg-6">
