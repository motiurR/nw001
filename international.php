                ...
                <div class="row">
                    <div class="col-lg-9">
                        <div class="row">
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $internationalTNews = $news->getTopInternationalNews();
                                  if ($internationalTNews) {
                                    while ($result = $internationalTNews->fetch_assoc()) {
                              ?>
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $internationalAllTNews = $news->getAllInternationalNewsinner();
                                  if ($internationalAllTNews) {
                                    while ($result = $internationalAllTNews->fetch_assoc()) {
                              ?>
                             <div class="col-lg-6">
                                <div class="content">
                                    <div class="col-lg-6">
