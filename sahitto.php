                ...
                <div class="row">
                    <div class="col-lg-9">
                        <div class="row">
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $sahittoTNews = $news->getsahittoTopNews();
                                  if ($sahittoTNews) {
                                    while ($result = $sahittoTNews->fetch_assoc()) {
                              ?>
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $sahittoAllTNews = $news->getAllsahittoNewsinner();
                                  if ($sahittoAllTNews) {
                                    while ($result = $sahittoAllTNews->fetch_assoc()) {
                              ?>
                             <div class="col-lg-6">
                                <div class="content">
                                    <div class="col-lg-6">
