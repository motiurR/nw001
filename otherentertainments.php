                ...
                <div class="row">
                    <div class="col-lg-9">
                        <div class="row">
                          ...
                          <?php
                               $news = new NewsAddN();
                                $otherEntertainmentTNews = $news->getOtherEntertainmentTopNews();
                                if ($otherEntertainmentTNews) {
                                  while ($result = $otherEntertainmentTNews->fetch_assoc()) {
                            ?>
                        ...
                        <?php
                             $news = new NewsAddN();
                              $otherEntertainmentAllTNews = $news->getAllOtherEntertainmentinner();
                              if ($otherEntertainmentAllTNews) {
                                while ($result = $otherEntertainmentAllTNews->fetch_assoc()) {
                          ?>
                             <div class="col-lg-6">
                                <div class="content">
                                    <div class="col-lg-6">
