                ...
                <div class="row">
                    <div class="col-lg-9">
                        <div class="row">
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $brahmonbariatNews = $news->brahmonbariaTopNews();
                                  if ($brahmonbariatNews) {
                                    while ($result = $brahmonbariatNews->fetch_assoc()) {
                              ?>
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $brahmonbariaalNews = $news->brahmonbariaallNews();
                                  if ($brahmonbariaalNews) {
                                    while ($result = $brahmonbariaalNews->fetch_assoc()) {
                              ?>
                             <div class="col-lg-6">
                                <div class="content">
                                    <div class="col-lg-6">
