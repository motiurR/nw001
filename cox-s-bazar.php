                ...
                <div class="row">
                    <div class="col-lg-9">
                        <div class="row">
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $cox_s_bazartNews = $news->cox_s_bazarTopNews();
                                  if ($cox_s_bazartNews) {
                                    while ($result = $cox_s_bazartNews->fetch_assoc()) {
                              ?>
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $cox_s_bazaralNews = $news->cox_s_bazarallNews();
                                  if ($cox_s_bazaralNews) {
                                    while ($result = $cox_s_bazaralNews->fetch_assoc()) {
                              ?>
                             <div class="col-lg-6">
                                <div class="content">
                                    <div class="col-lg-6">
