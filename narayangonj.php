                ...
                <div class="row">
                    <div class="col-lg-9">
                        <div class="row">
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $narayangonjTNews = $news->narayangonjTopNews();
                                  if ($narayangonjTNews) {
                                    while ($result = $narayangonjTNews->fetch_assoc()) {
                              ?>
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $mnarayangonjalNews = $news->narayangonjallNews();
                                  if ($mnarayangonjalNews) {
                                    while ($result = $mnarayangonjalNews->fetch_assoc()) {
                              ?>
                             <div class="col-lg-6">
                                <div class="content">
                                    <div class="col-lg-6">
