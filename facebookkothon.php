                ...
                <div class="row">
                    <div class="col-lg-9">
                        <div class="row">
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $facekothonTNews = $news->getFacebookKothonTopNews();
                                  if ($facekothonTNews) {
                                    while ($result = $facekothonTNews->fetch_assoc()) {
                              ?>
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $facekothonAllTNews = $news->getAllfaceKothonNewsinner();
                                  if ($facekothonAllTNews) {
                                    while ($result = $facekothonAllTNews->fetch_assoc()) {
                              ?>
                             <div class="col-lg-6">
                                <div class="content">
                                    <div class="col-lg-6">
