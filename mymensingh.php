                ...
                <div class="row">
                    <div class="col-lg-9">
                        <div class="row">
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $mymensinghTNews = $news->getTopmymensinghNews();
                                  if ($mymensinghTNews) {
                                    while ($result = $mymensinghTNews->fetch_assoc()) {
                              ?>
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $mymensinghNews = $news->getAllmymensinghNews();
                                  if ($mymensinghNews) {
                                    while ($result = $mymensinghNews->fetch_assoc()) {
                              ?>
                             <div class="col-lg-6">
                                <div class="content">
                                    <div class="col-lg-6">
