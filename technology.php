                ...
                <div class="row">
                    <div class="col-lg-9">
                        <div class="row">
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $technologyTNews = $news->getTechnologyTopNews();
                                  if ($technologyTNews) {
                                    while ($result = $technologyTNews->fetch_assoc()) {
                              ?>
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $technologyAllTNews = $news->getAlltechnologyNewsinner();
                                  if ($technologyAllTNews) {
                                    while ($result = $technologyAllTNews->fetch_assoc()) {
                              ?>
                             <div class="col-lg-6">
                                <div class="content">
                                    <div class="col-lg-6">
