                ...
                <div class="row">
                    <div class="col-lg-9">
                        <div class="row">
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $netrokonaTNews = $news->getTopnetrokonaNews();
                                  if ($netrokonaTNews) {
                                    while ($result = $netrokonaTNews->fetch_assoc()) {
                              ?>
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $netrokonaNews = $news->getAllnetrokonaNews();
                                  if ($netrokonaNews) {
                                    while ($result = $netrokonaNews->fetch_assoc()) {
                              ?>
                             <div class="col-lg-6">
                                <div class="content">
                                    <div class="col-lg-6">
