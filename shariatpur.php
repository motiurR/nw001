                ...
                <div class="row">
                    <div class="col-lg-9">
                        <div class="row">
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $shariatpurTNews = $news->shariatpurTopNews();
                                  if ($shariatpurTNews) {
                                    while ($result = $shariatpurTNews->fetch_assoc()) {
                              ?>
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $shariatpuralNews = $news->shariatpurllNews();
                                  if ($shariatpuralNews) {
                                    while ($result = $shariatpuralNews->fetch_assoc()) {
                              ?>
                             <div class="col-lg-6">
                                <div class="content">
                                    <div class="col-lg-6">
