                ...
                <div class="row">
                    <div class="col-lg-9">
                        <div class="row">
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $manikgonjTNews = $news->manikgonjTopNews();
                                  if ($manikgonjTNews) {
                                    while ($result = $manikgonjTNews->fetch_assoc()) {
                              ?>
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $manikgonjalNews = $news->manikgonjallNews();
                                  if ($manikgonjalNews) {
                                    while ($result = $manikgonjalNews->fetch_assoc()) {
                              ?>
                             <div class="col-lg-6">
                                <div class="content">
                                    <div class="col-lg-6">
