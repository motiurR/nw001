                ...
                <div class="row">
                    <div class="col-lg-9">
                        <div class="row">
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $thakurgaongTNews = $news->thakurgaongTopNews();
                                  if ($thakurgaongTNews) {
                                    while ($result = $thakurgaongTNews->fetch_assoc()) {
                              ?>
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $thakurgaongalNews = $news->thakurgaongallNews();
                                  if ($thakurgaongalNews) {
                                    while ($result = $thakurgaongalNews->fetch_assoc()) {
                              ?>
                             <div class="col-lg-6">
                                <div class="content">
                                    <div class="col-lg-6">
