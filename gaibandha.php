                ...
                <div class="row">
                    <div class="col-lg-9">
                        <div class="row">
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $gaibandhaTNews = $news->getTopgaibandhaNews();
                                  if ($gaibandhaTNews) {
                                    while ($result = $gaibandhaTNews->fetch_assoc()) {
                              ?>
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $gaibandhaNews = $news->getAllgaibandhaNews();
                                  if ($gaibandhaNews) {
                                    while ($result = $gaibandhaNews->fetch_assoc()) {
                              ?>
                             <div class="col-lg-6">
                                <div class="content">
                                    <div class="col-lg-6">
