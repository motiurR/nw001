                ...
                <div class="row">
                    <div class="col-lg-9">
                        <div class="row">
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $patuakhaliTNews = $news->patuakhaliTopNews();
                                  if ($patuakhaliTNews) {
                                    while ($result = $patuakhaliTNews->fetch_assoc()) {
                              ?>
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $patuakhalialNews = $news->patuakhaliallNews();
                                  if ($patuakhalialNews) {
                                    while ($result = $patuakhalialNews->fetch_assoc()) {
                              ?>
                             <div class="col-lg-6">
                                <div class="content">
                                    <div class="col-lg-6">
