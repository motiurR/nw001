                ...
                <div class="row">
                    <div class="col-lg-9">
                        <div class="row">
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $lakshmipurtNews = $news->lakshmipurTopNews();
                                  if ($lakshmipurtNews) {
                                    while ($result = $lakshmipurtNews->fetch_assoc()) {
                              ?>
                            ...
                            <?php
                                 $news = new NewsAddN();
                                  $lakshmipuralNews = $news->lakshmipurallNews();
                                  if ($lakshmipuralNews) {
                                    while ($result = $lakshmipuralNews->fetch_assoc()) {
                              ?>
                             <div class="col-lg-6">
                                <div class="content">
                                    <div class="col-lg-6">
